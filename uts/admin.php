...
<div class="row mb-3 mt-3">
         <div class="col-md-12">
          ...
          <a href="list_about.php" class="btn btn-success">Edit About</a>
          <a href="list_bisnis.php" class="btn btn-success">Edit Bisnis</a>
          <a href="list_kontak.php" class="btn btn-success">Edit Kontak</a>
          <a href="list_portofolio.php" class="btn btn-success">Edit Portofolio</a>
          </div>
        <br>
        <br>
</div>
