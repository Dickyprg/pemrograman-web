...
<body id="page-top">
  ...
  <nav id="sidebar-wrapper">
    <ul class="sidebar-nav">
      <li class="sidebar-brand">
        <a class="js-scroll-trigger" href="admin.php">Admin</a>
      </li>
  ...
  <header class="header">
    <div class="container text-center my-auto">
      <h1 class="mb-1"> TENTANG PORTOFOLIOKU</h1>
      <h3 class="mb-5">
        <em>mampir sini kepoin tentang saya</em>
      </h3>
      <a class="btn btn-primary btn-xl js-scroll-trigger" href="portofolio.php">Lebih lengkap</a>
    </div>
